...
public class DOM4JTest {
    ...
    public void name() {
        ...
        Element bean = root.element("PROPERTIES");
        List property = bean.elements("PROPERTY");
        System.out.println(String.format("属性的数量：%s。", property.size()));
    }
    ...
    public void write() throws DocumentException, IOException {
        ...
        XMLWriter writer = new XMLWriter(
                new OutputStreamWriter(new FileOutputStream(tempFile, true), CharsetEnum.UTF8.getValue()));
        // 创建格式化输出器
        OutputFormat format = OutputFormat.createPrettyPrint();
