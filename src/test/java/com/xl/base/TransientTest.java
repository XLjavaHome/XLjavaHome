...
public class TransientTest {
    ...
    public void demoTest() throws IOException, ClassNotFoundException {
        ...
        ObjectOutputStream o = new ObjectOutputStream(new FileOutputStream(ResourceUtil.createResourceFile(fileName)));
        o.writeObject(userInfo);
        o.close();
        //在反序列化之前改变name的值
        userInfo.setName("测试");
        // 重新读取内容,password不会读出来
        ObjectInputStream in = new ObjectInputStream(ResourceUtil.getResourceFileInputStream(fileName));
