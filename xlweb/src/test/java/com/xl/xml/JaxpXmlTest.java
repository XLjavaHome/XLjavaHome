...
public class JaxpXmlTest {
    ...
    public void before() throws UnsupportedEncodingException {
        inputStream = ResourceUtil.getResourceInputStream("src/src/main/resources/xml/book.xml");
    }
    ...
    public void read3() throws Exception {
        DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
        DocumentBuilder builder = factory.newDocumentBuilder();
        Document document = builder.parse("src/src/main/resources/xml/book.xml");
        // Element是Node的子类,强转
    ...
    public void add() throws Exception {
        ...
        tf.transform(new DOMSource(document), new StreamResult(new FileOutputStream("src/src/main/resources/xml/book.xml")));
