...
public class FreemarkerTest {
    ...
    private Map getData() throws IOException {
        ...
        map.put("NAME", "徐立");
        map.put("src/src/main/resources/image", FreemarkerUtil.getImage(ResourceUtil.getResourceInputStream("freemarker/a.jpg")));
        map.put("SEX", "男");
    ...
    public void list2Test() throws IOException, TemplateException {
        ...
        FreemarkerUtil.analysisTemplate("src/src/test/resources/freemarker/list.ftl", f.getPath(), map);
        FileUtil.open(f);
    }
}
