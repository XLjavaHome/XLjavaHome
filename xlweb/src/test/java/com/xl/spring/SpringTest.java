...
@ContextConfiguration(locations = {"src/src/main/resources/spring/applicationContext.xml", "classpath:spring/applicationContext-dao-BasicDataSource.xml"})
@Log4j
public class SpringTest {
    ////可以直接初始化
    ApplicationContext ctx = new ClassPathXmlApplicationContext("src/src/main/resources/spring/applicationContext.xml");
    @Autowired
