...
public class TranslateTest {
    ...
    public static void translate(String cn) {
        //http://translate.google.cn/translate_a/single?client=gtx&sl=zh-CN&tl=en&dt=t&q=googleq=我想   喝水,我要回老家了+
        String url = "http://translate.google.cn/translate_a/single?client=gtx&sl=zh-CN&tl=en&dt=t&q=googleq=" + cn
                .trim(); //sl,tl参数可换成其他国家
